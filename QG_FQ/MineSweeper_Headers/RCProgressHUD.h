...
@interface RCProgressHUD : UIView
{
    ...
    float progress;
    float _cornerRadius;
    id <RCProgressHUDDelegate> delegate;
    UIColor *color;
    UIFont *labelFont;
    UIColor *labelColor;
...
@property _Bool diRCackground; // @synthesize diRCackground;
...
@property __weak id <RCProgressHUDDelegate> delegate; // @synthesize delegate;
