...
#import "BMKBaseURLSessionManager.h"

#import "NSCopying-Protocol.h"
#import "NSSecureCoding-Protocol.h"

@class BMKBaseHTTPRequestSerializer, BMKBaseHTTPResponseSerializer, BMKBaseSecurityPolicy, NSURL;
@protocol BMKBaseURLRequestSerialization, BMKBaseURLResponseSerialization;

@interface BMKBaseHTTPSessionManager : BMKBaseURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
    BMKBaseHTTPRequestSerializer<BMKBaseURLRequestSerialization> *_requestSerializer;
}

+ (_Bool)supportsSecureCoding;
+ (id)manager;
@property(retain, nonatomic) BMKBaseHTTPRequestSerializer<BMKBaseURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
...
@property(retain, nonatomic) BMKBaseSecurityPolicy *securityPolicy; // @dynamic securityPolicy;
@property(retain, nonatomic) BMKBaseHTTPResponseSerializer<BMKBaseURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
