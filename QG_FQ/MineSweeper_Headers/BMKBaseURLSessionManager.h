...
@class BMKBaseNetworkReachabilityManager, BMKBaseSecurityPolicy, NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration;
@protocol BMKBaseURLResponseSerialization, OS_dispatch_group, OS_dispatch_queue;

@interface BMKBaseURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    _Bool _attemptsToRecreateUploadTasksForBackgroundSessions;
    NSURLSession *_session;
    NSOperationQueue *_operationQueue;
    id <BMKBaseURLResponseSerialization> _responseSerializer;
    BMKBaseSecurityPolicy *_securityPolicy;
    BMKBaseNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) BMKBaseNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) BMKBaseSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
@property(retain, nonatomic) id <BMKBaseURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;
