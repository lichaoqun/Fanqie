...
@protocol WLChainRequestDelegate;

@interface WLChainRequest : NSObject <WLRequestDelegate>
{
    id <WLChainRequestDelegate> _delegate;
...
@property(nonatomic) __weak id <WLChainRequestDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)clearRequest;
