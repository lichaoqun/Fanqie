...
@class BMKBaseHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;
@protocol NSStreamDelegate;

@interface BMKBaseMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    BMKBaseHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) BMKBaseHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
