...
@class BMKInternalMapView, NSTimer;
@protocol BMKTapDetectingViewDelegate;

@interface BMKTapDetectingView : UIView
{
    ...
    struct BMKPoint _twoPointCenterGeo;
    double _length;
    int _mode;
    int _lookOverCount;
    ...
    id <BMKTapDetectingViewDelegate> delegate;
    BMKInternalMapView *_mapView;
}

@property(nonatomic) __weak BMKInternalMapView *mapView; // @synthesize mapView=_mapView;
...
@property(nonatomic) __weak id <BMKTapDetectingViewDelegate> delegate; // @synthesize delegate;
- (void).cxx_destruct;
- (void)resetParas;
