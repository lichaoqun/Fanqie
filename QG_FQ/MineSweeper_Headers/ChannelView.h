...
@interface ChannelView : UIView <UICollectionViewDataSource, UICollectionViewDelegate>
{
    NSArray *_channelArray;
    long long _selectChannel;
...
@property(nonatomic) long long selectChannel; // @synthesize selectChannel=_selectChannel;
