...
+ (id)fetchAllAlbumsWithAlbumContentType:(long long)arg1 showEmptyAlbum:(_Bool)arg2 showSmartAlbum:(_Bool)arg3;
+ (id)createFetchOptionsWithAlbumContentType:(long long)arg1;
