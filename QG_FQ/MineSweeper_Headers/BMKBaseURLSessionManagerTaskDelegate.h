...
@class BMKBaseURLSessionManager, NSMutableData, NSProgress, NSString, NSURL;

@interface BMKBaseURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    BMKBaseURLSessionManager *_manager;
...
@property(nonatomic) __weak BMKBaseURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
