...
@class MKMapView, NSString, RCLocationViewControllerAnnotation;

@interface RCLocationViewController : RCBaseViewController <MKMapViewDelegate>
{
    NSString *_locationName;
    MKMapView *_mapView;
    RCLocationViewControllerAnnotation *_annotation;
    struct CLLocationCoordinate2D _location;
}

@property(retain, nonatomic) RCLocationViewControllerAnnotation *annotation; // @synthesize annotation=_annotation;
