...
@interface JLSendRedPacketViewController : QDCommonViewController <QMUIModalPresentationViewControllerDelegate>
{
    NSString *_groupId;
    NSString *_redTitle;
...
@property(copy, nonatomic) NSString *redTitle; // @synthesize redTitle=_redTitle;
