...
#import "BMKBaseMultipartFormData-Protocol.h"

@class BMKBaseMultipartBodyStream, NSMutableURLRequest, NSString;

@interface BMKBaseStreamingMultipartFormData : NSObject <BMKBaseMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    BMKBaseMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) BMKBaseMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
